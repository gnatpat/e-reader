#include "hal/app_loader.h"

#include <esp_heap_caps.h>
#include <soc/soc.h>           // MAP_IRAM_TO_DRAM, SOC_I_D_OFFSET

#include "config.h"            // MAX_APP_BINARY
#include "hal/input.h"         // resetInputFrontend
#include "pala_app.h"          // PalaAppHeader, PALA_APP_MAGIC, pala_app_entry_t
#include "pure/app_header.h"   // validateAppHeader, validateRelocEntries
