...
#include "hal/app_loader.h"       // loadAndRunApp, LoadResult
#include "hal/display.h"          // u8g2, display
#include "hal/input.h"            // g_btns, waitForNextEvent, ButtonEvent
#include "pala_api.h"             // PalaAPI
#include "pala_app.h"             // PALA_CLICK/DOUBLE/TRIPLE/LONG
#include "state.h"                // FS, prefs
#include "ui/font.h"
#include "ui/widgets.h"           // drawCenter, drawSectionHeader, prepareMenuFrame
